...
# Clase Inventario: Gestiona una colección de productos utilizando un diccionario para almacenamiento eficiente.
# Ahora incluye manejo de archivos para persistencia.
class Inventario:
    def __init__(self, archivo="inventario.txt"):
        self.productos = {}  # Diccionario para almacenar objetos Producto, con ID como clave
            ...
            with open(self.archivo, 'r') as file:
                for linea in file:
                    ...
                    if id_prod in self.productos:
                        print(f"Advertencia: ID duplicado {id_prod} en el archivo. Sobrescribiendo con el último valor.")
    ...
    def insertar_producto(self, nuevo_producto):
        id_nuevo = nuevo_producto.get_id()
        if id_nuevo in self.productos:
            print("Error: El ID del producto ya existe en el inventario.")
            return
        self.productos[id_nuevo] = nuevo_producto
        self.guardar_inventario()
        print("Producto añadido exitosamente.")

    # Metodo para eliminar un producto por ID
    def remover_producto(self, id_a_remover):
        if id_a_remover in self.productos:
            del self.productos[id_a_remover]
            self.guardar_inventario()
    ...
    def modificar_producto(self, id_a_modificar, nuevo_stock=None, nuevo_costo=None):
        if id_a_modificar in self.productos:
            prod = self.productos[id_a_modificar]
